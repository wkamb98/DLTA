...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  /// Navigates to the androidMthreeContainerScreen when the action is triggered.

  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the androidMthreeContainerScreen.
  onTapAndroidMThreeContainer() {
    Get.toNamed(
      AppRoutes.androidMthreeContainerScreen,
    );
  }
  ...
  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the k4Screen.
  onTaptf1() {
    Get.toNamed(
      AppRoutes.k4Screen,
    );
